...
export class CollectionDetailComponent implements OnInit {
  ...
  closeResult = '';
  private collectionDetailApiUrl = 'https://localhost:44328/api/CollectionDetail';
  private personApiUrl = 'http://localhost:9191/api/Person';
  private harvestApiUrl = 'https://localhost:44328/api/Harvest';
  ...
  getHarvestStage(harvestId: number): string {
    ...
    return harvest ? harvest.stage : 'N/A';
  }
}
